...
@Sql(scripts = "/sql/estacionamentos/estacionamentos-delete.sql", 
...
public class EstacionamentoIT {
    ...
    public void criarCheckin_ComDadosValidos_RetornarCreatedAndLocation() {
        ...
        testClient.post().uri("/api/v2/estacionamentos/check-in")
    ...
    @Sql(scripts = "/sql/estacionamentos/estacionamentos-insert-vagas-ocupadas.sql", 
        executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    @Sql(scripts = "/sql/estacionamentos/estacionamentos-delete-vagas-ocupadas.sql", 
        executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    @Test
    ...
    public void buscarCheckin_ComReciboInexistente_RetornarErrorStatus404() {
        ...
        testClient.get()
            .uri("/api/v2/estacionamentos/check-in/{recibo}", "20230313-999999")
            .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bob@email.com.br", "123456"))
            .exchange()
            .expectStatus().isNotFound()
            .expectBody()
            .jsonPath("status").isEqualTo("404")
            .jsonPath("path").isEqualTo("/api/v2/estacionamentos/check-in/20230313-999999")
    ...
    public void criarCheckOut_ComReciboInexistente_RetornarErrorStatus404() {
        ...
        testClient.put()
            .uri("/api/v2/estacionamentos/check-out/{recibo}", "20230313-000000")
            .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com.br", "123456"))
            .exchange()
            .expectStatus().isNotFound()
            .expectBody()
            .jsonPath("status").isEqualTo("404")
            .jsonPath("path").isEqualTo("/api/v2/estacionamentos/check-out/20230313-000000")
    ...
    public void criarCheckOut_ComRoleCliente_RetornarErrorStatus403() {
        ...
        testClient.put()
            ...
            .expectBody()
            .jsonPath("status").isEqualTo("403")
            .jsonPath("path").isEqualTo("/api/v2/estacionamentos/check-out/20230313-101300")
            .jsonPath("method").isEqualTo("PUT");
    }
    ...
    public void buscarEstacionamentos_PorClienteCpfComPerfilCliente_RetornarErrorStatus403() {
        ...
        testClient.get()
            .uri("/api/v2/estacionamentos/cpf/{cpf}", "98401203015")
            .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@email.com.br", "123456"))
            .exchange()
            .expectStatus().isForbidden()
            .expectBody()
    ...
    public void buscarEstacionamentos_DoClienteLogado_RetornarSucesso() {
        ...
        PageableDto responseBody = testClient.get()
            .uri("/api/v2/estacionamentos?size=1&page=0")
            .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bob@email.com.br", "123456"))
            .exchange()
            .expectStatus().isOk()
            .expectBody(PageableDto.class)
