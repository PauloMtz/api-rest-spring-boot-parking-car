...
import com.parking.web.dto.mapper.ClienteMapper;
...
public class ClienteController {
    ...
    public ResponseEntity<PageableDto> getAll(@Parameter(hidden = true)
        ...
        return ResponseEntity.ok(PageableMapper.toPageableDto(clientes));
    }
    ...
    @GetMapping("/detalhes")
    @PreAuthorize("hasRole('CLIENTE')")
    public ResponseEntity<ClienteResponseDTO> getDetalhes(
            @AuthenticationPrincipal JwtUserDetails userDetails) {
